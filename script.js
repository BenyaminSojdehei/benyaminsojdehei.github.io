...
if (menuButton && nav) {
    ...
    document.addEventListener("click", event => {
        ...
        if (!clickedNav && !clickedButton && nav.classList.contains("open")) {
            nav.classList.remove("open");
            menuButton.setAttribute("aria-expanded", "false");
        }
    });
...
timelineItems.forEach(item => {
    ...
    head.addEventListener("click", () => {
        ...
        timelineItems.forEach(otherItem => {
            ...
            const otherHead = otherItem.querySelector(".timeline-head");
            if (otherHead) {
...
const firstTimelineItem = document.querySelector("#timeline .timeline-item");

if (firstTimelineItem) {
    firstTimelineItem.classList.add("open");

    const firstHead = firstTimelineItem.querySelector(".timeline-head");
    if (firstHead) {
...
certificateItems.forEach(item => {
    ...
    const head = item.querySelector(".certificate-head");
    if (!head) return;
    ...
    head.addEventListener("click", () => {
        ...
        certificateItems.forEach(otherItem => {
            ...
            const otherHead = otherItem.querySelector(".certificate-head");
            if (otherHead) {
                otherHead.setAttribute("aria-expanded", "false");
            }
        });
...
if (contactForm) {
    ...
    contactForm.addEventListener("submit", event => {
        ...
        submitButton.textContent = "Form service not connected";
